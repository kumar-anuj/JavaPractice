...
public class StreamReductionExample1 {
    public static void main(String[] args) {
        ...
        // Average Age by Dept
        System.out.println(empLst.stream().filter(e -> e.getDept().equals("ENG")).collect(Collectors.averagingDouble(Employee::getAge)));
        ...
        System.out.println(empLst.stream().collect(Collectors.groupingBy(e -> e.getDept())));
        System.out.println(empLst.stream().collect(Collectors.groupingBy(e -> e.getDept(), Collectors.counting())));

    }

    public static List<Employee> createEmployeeList() {
        Employee emp1 = new Employee("anuj", "1001",
                new Date(), new Desk(7026, 6173235L), 10000, 35, "ENG");
        Employee emp2 = new Employee("abhi", "1002",
                new Date(), new Desk(7027, 6173233L), 20000, 26, "FIN");
        Employee emp3 = new Employee("mayank", "1003",
                new Date(), new Desk(7028, 6173233L), 15000, 40 , "MAN");
        Employee emp4 = new Employee("vishal", "1004",
                new Date(), new Desk(7029, 6173232L), 100000, 34, "FIN");
        Employee emp5 = new Employee("rahul", "1005",
                new Date(), new Desk(7024, 6173231L), 20000, 30, "ENG");
        Employee emp6 = new Employee("anuj", "1006",
                new Date(), new Desk(8026, 6173235L), 50000, 43, "MAN");
        Employee emp7 = new Employee("mayank", "1007",
                new Date(), new Desk(8028, 6173233L), 55000, 25, "FIN");
